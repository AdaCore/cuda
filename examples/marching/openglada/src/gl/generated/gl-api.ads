...
package GL.API is
   ...
   type T72 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Blend_Factor);
   pragma Convention (StdCall, T72);
   type T73 is access procedure (P1, P2, P3, P4 : Blending.Blend_Factor);
   pragma Convention (StdCall, T73);
   type T74 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3, P4, P5 : Blending.Blend_Factor);
   pragma Convention (StdCall, T74);
   type T75 is access procedure (P1, P2, P3, P4 : Colors.Component);
   pragma Convention (StdCall, T75);
   type T76 is access procedure (P1 : Blending.Equation);
   pragma Convention (StdCall, T76);
   type T77 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2 : Blending.Equation);
   pragma Convention (StdCall, T77);
   type T78 is access procedure (P1, P2 : Blending.Equation);
   pragma Convention (StdCall, T78);
   type T79 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Equation);
   pragma Convention (StdCall, T79);
   type T80 is access procedure (P1 : Enums.Point_Param; P2 : Single);
   pragma Convention (StdCall, T80);
   type T81 is access procedure (P1 : UInt; P2 : Buffers.Explicit_Color_Buffer_List);
   pragma Convention (StdCall, T81);
   type T82 is access procedure (P1 : Buffers.Color_Buffer_Selector; P2 : Low_Level.Zero; P3 : Colors.Color);
   pragma Convention (StdCall, T82);
   type T83 is access procedure (P1 : Low_Level.Enums.Only_Color_Buffer; P2 : Buffers.Draw_Buffer_Index; P3 : Colors.Color);
   pragma Convention (StdCall, T83);
   type T84 is access procedure (P1 : Low_Level.Enums.Only_Depth_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Depth);
   pragma Convention (StdCall, T84);
   type T85 is access procedure (P1 : Low_Level.Enums.Only_Stencil_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Stencil_Index);
   pragma Convention (StdCall, T85);
   type T86 is access procedure (P1 : Low_Level.Enums.Only_Depth_Stencil_Buffer; P2 : Low_Level.Zero; P3 : Buffers.Depth; P4 : Buffers.Stencil_Index);
   pragma Convention (StdCall, T86);
   type T87 is access procedure (P1 : Culling.Face_Selector; P2 : Compare_Function; P3 : Int; P4 : UInt);
   pragma Convention (StdCall, T87);
   type T88 is access procedure (P1 : Culling.Face_Selector; P2, P3, P4 : Buffers.Stencil_Action);
   pragma Convention (StdCall, T88);
   type T89 is access procedure (P1 : Culling.Face_Selector; P2 : UInt);
   pragma Convention (StdCall, T89);
   type T90 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size; P5 : Low_Level.Zero; P6 : Size; P7 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T90);
   type T91 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3, P4 : Int; P5, P6 : Size; P7 : Pixels.Data_Format; P8 : Pixels.Data_Type; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T91);
   type T92 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4 : Size);
   pragma Convention (StdCall, T92);
   type T93 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size; P6 : Low_Level.Zero; P7 : Size; P8 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T93);
   type T94 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T94);
   type T95 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Pixels.Data_Format; P9 : Pixels.Data_Type; P10 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T95);
   type T96 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Size; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T96);
   type T97 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
   pragma Convention (StdCall, T97);
   type T98 is access procedure (P1 : Int);
   pragma Convention (StdCall, T98);
   type T99 is access procedure (P1 : Low_Level.Enums.Texture_Kind);
   pragma Convention (StdCall, T99);
   type T100 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T100);
   type T101 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level; P3, P4, P5 : Int; P6, P7, P8 : Size);
   pragma Convention (StdCall, T101);
   type T102 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T102);
   type T103 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T103);
   type T104 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T104);
   type T105 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T105);
   type T106 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T106);
   type T107 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T109);
   type T110 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T113);
   type T114 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : Size; P2 : out UInt);
   ...
   type T121 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T121);
   type T122 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T122);
   type T123 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   ...
   type T129 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T129);
   type T130 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T142);
   type T143 is access function (P1 : Objects.Shaders.Shader_Type) return Uint;
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.CharPtr_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T146);
   type T147 is access procedure;
   pragma Convention (StdCall, T147);
   type T148 is access function return UInt;
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T153);
   type T154 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T154);
   type T155 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T155);
   type T156 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T157);
   type T158 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.Strings.chars_ptr);
   pragma Convention (StdCall, T163);
   type T164 is access function (P1 : UInt; P2 : Interfaces.C.Strings.chars_ptr) return Int;
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T165);
   type T166 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Blend_Func_I : T72;
   Blend_Func_Separate : T73;
   Blend_Func_Separate_I : T74;
   Blend_Color : T75;
   Blend_Equation : T76;
   Blend_Equation_I : T77;
   Blend_Equation_Separate : T78;
   Blend_Equation_Separate_I : T79;
   ...
   Clear_Accum : T75;
   Clear_Buffer : T82;
   Clear_Draw_Buffer : T83;
   Clear_Buffer_Depth : T84;
   Clear_Buffer_Stencil : T85;
   Clear_Buffer_Depth_Stencil : T86;
   ...
   Stencil_Func_Separate : T87;
   Stencil_Op_Separate : T88;
   Stencil_Mask_Separate : T89;
   ...
   Tex_Storage_2D : T94;
   Tex_Image_3D : T95;
   Compressed_Tex_Image_3D : T96;
   Tex_Sub_Image_3D : T91;
   Tex_Storage_3D : T97;
   ...
   Active_Texture : T98;
   Generate_Mipmap : T99;
   Invalidate_Tex_Image : T100;
   Invalidate_Tex_Sub_Image : T101;
   Gen_Buffers : T102;
   Delete_Buffers : T103;
   Bind_Buffer : T104;
   Buffer_Data : T105;
   Map_Buffer : T106;
   Buffer_Pointer : T107;
   Buffer_Sub_Data : T108;
   Unmap_Buffer : T109;
   Get_Buffer_Parameter_Access_Kind : T110;
   Get_Buffer_Parameter_Bool : T111;
   Get_Buffer_Parameter_Size : T112;
   Get_Buffer_Parameter_Usage : T113;
   Invalidate_Buffer_Data : T114;
   Invalidate_Buffer_Sub_Data : T115;
   Gen_Vertex_Arrays : T116;
   Delete_Vertex_Arrays : T117;
   Bind_Vertex_Array : T118;
   Gen_Renderbuffers : T119;
   Delete_Renderbuffers : T120;
   Renderbuffer_Storage : T121;
   Renderbuffer_Storage_Multisample : T122;
   Bind_Renderbuffer : T123;
   Get_Renderbuffer_Parameter_Int : T124;
   Get_Renderbuffer_Parameter_Internal_Format : T125;
   ...
   Gen_Framebuffers : T127;
   Delete_Framebuffers : T128;
   Bind_Framebuffer : T129;
   Check_Framebuffer_Status : T130;
   Framebuffer_Renderbuffer : T131;
   Framebuffer_Texture : T132;
   Framebuffer_Texture_Layer : T133;
   Blit_Framebuffer : T134;
   Invalidate_Framebuffer : T135;
   Invalidate_Sub_Framebuffer : T136;
   Framebuffer_Parameter_Size : T137;
   Framebuffer_Parameter_Bool : T138;
   Get_Framebuffer_Parameter_Size : T139;
   Get_Framebuffer_Parameter_Bool : T140;
   Get_Shader_Param : T141;
   Get_Shader_Type : T142;
   Create_Shader : T143;
   Delete_Shader : T144;
   Shader_Source : T145;
   Get_Shader_Source : T146;
   Compile_Shader : T144;
   Release_Shader_Compiler : T147;
   Get_Shader_Info_Log : T146;
   Create_Program : T148;
   Delete_Program : T149;
   Get_Program_Param : T150;
   Attach_Shader : T151;
   Link_Program : T149;
   Get_Program_Info_Log : T152;
   Get_Program_Stage : T153;
   Get_Subroutine_Index : T154;
   Get_Subroutine_Uniform_Location : T155;
   Use_Program : T149;
   Validate_Program : T149;
   Get_Uniform_Location : T156;
   Bind_Attrib_Location : T157;
   Get_Attrib_Location : T158;
   Vertex_Attrib_Pointer : T159;
   Vertex_AttribI_Pointer : T160;
   Vertex_AttribL_Pointer : T160;
   Enable_Vertex_Attrib_Array : T161;
   Disable_Vertex_Attrib_Array : T161;
   Get_Attached_Shaders : T162;
   Bind_Frag_Data_Location : T163;
   Get_Frag_Data_Location : T164;
   Set_Patch_Parameter_Int : T165;
   Set_Patch_Parameter_Float_Array : T166;
